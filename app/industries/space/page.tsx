    ...
    >
      ...
      <section className="mb-16 bg-gray-50 p-8 rounded-lg">
        ...
        <p className="text-gray-600 mb-6">
          We manufacture precision components for a wide range of space
          applications. Our experience across multiple subsystems gives us the
          versatility to support complete spacecraft programs.
        </p>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              icon: Orbit,
              title: "Satellite Structural Components",
              desc: "Primary and secondary structural elements, brackets, panels, and chassis components that form the backbone of satellite buses.",
            },
            {
              icon: Rocket,
              title: "Propulsion System Parts",
              desc: "Valve bodies, manifolds, injector components, and thruster mounting hardware for chemical and electric propulsion systems.",
            },
            {
              icon: Shield,
              title: "Thermal Control Hardware",
              desc: "Heat sinks, thermal straps, radiator panel fittings, cold plates, and multi-layer insulation attachment hardware.",
            },
            {
              icon: Orbit,
              title: "Antenna Mounts & Waveguides",
              desc: "Precision antenna mounting brackets, feed horn components, and waveguide assemblies requiring tight positional accuracy.",
            },
            {
              icon: Rocket,
              title: "Deployment Mechanisms",
              desc: "Hinge assemblies, latch mechanisms, release devices, and actuator housings for deployable solar arrays, antennas, and booms.",
            },
            {
              icon: Microscope,
              title: "Optical Instrument Housings",
              desc: "Mirror mounts, lens barrels, baffle assemblies, and optical bench components with exceptional surface finish and dimensional stability.",
            },
            {
              icon: Shield,
              title: "Reaction Wheel Components",
              desc: "Precision flywheels, bearing housings, and motor mounting components for attitude control reaction wheel assemblies.",
            },
            {
              icon: Feather,
              title: "Solar Panel Frames",
              desc: "Lightweight structural frames, hinge fittings, and deployment rail components for solar array substrates and mechanisms.",
            },
          ].map((item, i) => {
            const Icon = item.icon;
            return (
              <div key={i} className="bg-white p-5 rounded-lg">
                <div className="w-10 h-10 bg-[#17135F]/10 rounded-lg flex items-center justify-center mb-3">
